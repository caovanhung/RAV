...
from Detection_2DCode.DlogRDS.DlogDSS.Ui_DlogDSS.I_DlogDSS_2Dcode import Ui_DlogDSS_2Dcocde
    ...
    def func_readDataReaded_DSS_2Dcode(self):
        ...
        if (len(self.line57)!=1 ):
            ...
            if (self.var_datareaded!="Khong phat hien"):
                ...
                self.var_Ui_DSS_2Dcode.frame_selecRange_DSS_2Dcode.setEnabled(True) 
            else:
                self.var_Ui_DSS_2Dcode.frame_selecRange_DSS_2Dcode.setEnabled(False) 
