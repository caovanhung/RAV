...
#########  write Data config ####################################        
    ...
    def func_changeStartDigit_RDS_2Dcode(self):
        ...
        if (len(self.tmp_line73)!=1):
           ...
           if (self.tmp_textStartDigit!="" and self.tmp_textDataLength!="" and self.var_dataReaded!="Khong phat hien"):
               ...
               if self.var_Ui_RDS_2Dcode.cbox_OutputLength_RDS_2Dcode.isChecked():  
                    self.func_clickOutputLength_RDS_2Dcode()
