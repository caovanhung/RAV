...
class Class_XLA_2Dcode:
   ...
   # img_thred=0
   # img_c=0
    def __init__(self,img_1,img_2,x0,y0,x1,y1,var_fileImgRow,var_fileImgRowProcessed,var_fileImgProcessed):
        #self.img_t=img_t
        ...
        cv2.imwrite(var_fileImgRowProcessed, self.var_img_cut)
  ...
  #      return self.img
    ...
    def func_detectQR_Code(self):
        ...
        return  self.var_strQR,self.var_img,var_position
